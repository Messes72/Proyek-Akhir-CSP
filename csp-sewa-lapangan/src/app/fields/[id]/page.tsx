  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <Link href="/fields" className="text-green-600 hover:text-green-800 mb-4 inline-block">&larr; Kembali ke Daftar</Link>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
          ...
          <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900">{field.name}</h1>
            
            <div className="mt-3">
              <h2 className="sr-only">Product information</h2>
              <p className="text-3xl text-gray-900">Rp {field.price_per_hour.toLocaleString('id-ID')}/jam</p>
            </div>
            ...
            <div className="mt-8 bg-gray-50 p-6 rounded-lg border border-gray-200">
               <h3 className="text-lg font-medium text-gray-900">Booking Lapangan Ini</h3>
               <BookingForm fieldId={field.id} pricePerHour={field.price_per_hour} />
            </div>
          </div>
        </div>
      </div>
